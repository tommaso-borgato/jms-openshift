    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            if (req.getParameterMap().keySet().contains("produce")) {
                ...
                out.println("Usage:<ul>" + "<li>use <b>?produce</b> parameter to sent a message to test queue</li>"
                        + "<li>use <b>?produce-mdb</b> parameter to sent a message with 'consume=MDB' selector to test queue</li>"
                        + "<li>use <b>?consume</b> parameter to consume a message from test queue</li>" + "</ul>");
            }
